...
static PyObject* pyopencv_cv_AffineFeature_create(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv;
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "O|OOOO:AffineFeature_create", (char**)keywords, &pyobj_backend, &pyobj_maxTilt, &pyobj_minTilt, &pyobj_tiltStep, &pyobj_rotateStepBase) &&
...
static PyObject* pyopencv_cv_DualTVL1OpticalFlow_create(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    const char* keywords[] = { "tau", "lambda_", "theta", "nscales", "warps", "epsilon", "innnerIterations", "outerIterations", "scaleStep", "gamma", "medianFiltering", "useInitialFlow", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "|OOOOOOOOOOOO:DualTVL1OpticalFlow_create", (char**)keywords, &pyobj_tau, &pyobj_lambda_, &pyobj_theta, &pyobj_nscales, &pyobj_warps, &pyobj_epsilon, &pyobj_innnerIterations, &pyobj_outerIterations, &pyobj_scaleStep, &pyobj_gamma, &pyobj_medianFiltering, &pyobj_useInitialFlow) &&
        pyopencv_to_safe(pyobj_tau, tau, ArgInfo("tau", 0)) &&
        pyopencv_to_safe(pyobj_lambda_, lambda_, ArgInfo("lambda_", 0)) &&
    ...
    {
        ERRWRAP2(retval = cv::DualTVL1OpticalFlow::create(tau, lambda_, theta, nscales, warps, epsilon, innnerIterations, outerIterations, scaleStep, gamma, medianFiltering, useInitialFlow));
        return pyopencv_from(retval);
    }
...
static PyObject* pyopencv_cv_HoughLinesPointSet(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOOOOOOOO|O:HoughLinesPointSet", (char**)keywords, &pyobj_point, &pyobj_lines_max, &pyobj_threshold, &pyobj_min_rho, &pyobj_max_rho, &pyobj_rho_step, &pyobj_min_theta, &pyobj_max_theta, &pyobj_theta_step, &pyobj_lines) &&
...
static PyObject* pyopencv_cv_MSER_create(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "|OOOOOOOOO:MSER_create", (char**)keywords, &pyobj_delta, &pyobj_min_area, &pyobj_max_area, &pyobj_max_variation, &pyobj_min_diversity, &pyobj_max_evolution, &pyobj_area_threshold, &pyobj_min_margin, &pyobj_edge_blur_size) &&
        pyopencv_to_safe(pyobj_delta, delta, ArgInfo("delta", 0)) &&
...
static PyObject* pyopencv_cv_SIFT_create(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOOOOO:SIFT_create", (char**)keywords, &pyobj_nfeatures, &pyobj_nOctaveLayers, &pyobj_contrastThreshold, &pyobj_edgeThreshold, &pyobj_sigma, &pyobj_descriptorType) &&
        pyopencv_to_safe(pyobj_nfeatures, nfeatures, ArgInfo("nfeatures", 0)) &&
        pyopencv_to_safe(pyobj_nOctaveLayers, nOctaveLayers, ArgInfo("nOctaveLayers", 0)) &&
        pyopencv_to_safe(pyobj_contrastThreshold, contrastThreshold, ArgInfo("contrastThreshold", 0)) &&
        pyopencv_to_safe(pyobj_edgeThreshold, edgeThreshold, ArgInfo("edgeThreshold", 0)) &&
...
static PyObject* pyopencv_cv_blendLinear(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv;
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOOO|O:blendLinear", (char**)keywords, &pyobj_src1, &pyobj_src2, &pyobj_weights1, &pyobj_weights2, &pyobj_dst) &&
        pyopencv_to_safe(pyobj_src1, src1, ArgInfo("src1", 0)) &&
        pyopencv_to_safe(pyobj_src2, src2, ArgInfo("src2", 0)) &&
...
static PyObject* pyopencv_cv_createAffineTransformer(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "O:createAffineTransformer", (char**)keywords, &pyobj_fullAffine) &&
...
static PyObject* pyopencv_cv_createCalibrateDebevec(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "|OOO:createCalibrateDebevec", (char**)keywords, &pyobj_samples, &pyobj_lambda_, &pyobj_random) &&
        pyopencv_to_safe(pyobj_samples, samples, ArgInfo("samples", 0)) &&
        pyopencv_to_safe(pyobj_lambda_, lambda_, ArgInfo("lambda_", 0)) &&
        pyopencv_to_safe(pyobj_random, random, ArgInfo("random", 0)) )
    {
        ERRWRAP2(retval = cv::createCalibrateDebevec(samples, lambda_, random));
        return pyopencv_from(retval);
    }
...
static PyObject* pyopencv_cv_createChiHistogramCostExtractor(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "|OO:createChiHistogramCostExtractor", (char**)keywords, &pyobj_nDummies, &pyobj_defaultCost) &&
...
static PyObject* pyopencv_cv_createEMDHistogramCostExtractor(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "|OOO:createEMDHistogramCostExtractor", (char**)keywords, &pyobj_flag, &pyobj_nDummies, &pyobj_defaultCost) &&
...
static PyObject* pyopencv_cv_createEMDL1HistogramCostExtractor(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    const char* keywords[] = { "nDummies", "defaultCost", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "|OO:createEMDL1HistogramCostExtractor", (char**)keywords, &pyobj_nDummies, &pyobj_defaultCost) &&
        pyopencv_to_safe(pyobj_nDummies, nDummies, ArgInfo("nDummies", 0)) &&
        pyopencv_to_safe(pyobj_defaultCost, defaultCost, ArgInfo("defaultCost", 0)) )
    {
...
static PyObject* pyopencv_cv_createHausdorffDistanceExtractor(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "|OO:createHausdorffDistanceExtractor", (char**)keywords, &pyobj_distanceFlag, &pyobj_rankProp) &&
...
static PyObject* pyopencv_cv_createLineSegmentDetector(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "|OOOOOOOO:createLineSegmentDetector", (char**)keywords, &pyobj_refine, &pyobj_scale, &pyobj_sigma_scale, &pyobj_quant, &pyobj_ang_th, &pyobj_log_eps, &pyobj_density_th, &pyobj_n_bins) &&
...
static PyObject* pyopencv_cv_createNormHistogramCostExtractor(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    const char* keywords[] = { "flag", "nDummies", "defaultCost", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "|OOO:createNormHistogramCostExtractor", (char**)keywords, &pyobj_flag, &pyobj_nDummies, &pyobj_defaultCost) &&
        pyopencv_to_safe(pyobj_flag, flag, ArgInfo("flag", 0)) &&
        pyopencv_to_safe(pyobj_nDummies, nDummies, ArgInfo("nDummies", 0)) &&
        pyopencv_to_safe(pyobj_defaultCost, defaultCost, ArgInfo("defaultCost", 0)) )
    {
...
static PyObject* pyopencv_cv_createShapeContextDistanceExtractor(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "|OOOOOOO:createShapeContextDistanceExtractor", (char**)keywords, &pyobj_nAngularBins, &pyobj_nRadialBins, &pyobj_innerRadius, &pyobj_outerRadius, &pyobj_iterations, &pyobj_comparer, &pyobj_transformer) &&
...
static PyObject* pyopencv_cv_createStitcher(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "|O:createStitcher", (char**)keywords, &pyobj_try_use_gpu) &&
...
static PyObject* pyopencv_cv_createStitcherScans(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    const char* keywords[] = { "try_use_gpu", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "|O:createStitcherScans", (char**)keywords, &pyobj_try_use_gpu) &&
        pyopencv_to_safe(pyobj_try_use_gpu, try_use_gpu, ArgInfo("try_use_gpu", 0)) )
    {
...
static PyObject* pyopencv_cv_createThinPlateSplineShapeTransformer(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "|O:createThinPlateSplineShapeTransformer", (char**)keywords, &pyobj_regularizationParameter) &&
...
static PyObject* pyopencv_cv_denoise_TVL1(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OO|OO:denoise_TVL1", (char**)keywords, &pyobj_observations, &pyobj_result, &pyobj_lambda_, &pyobj_niters) &&
    ...
    {
        ERRWRAP2(cv::denoise_TVL1(observations, result, lambda_, niters));
        Py_RETURN_NONE;
    }
...
static PyObject* pyopencv_cv_divSpectrums(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv;
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOO|OO:divSpectrums", (char**)keywords, &pyobj_a, &pyobj_b, &pyobj_flags, &pyobj_c, &pyobj_conjB) &&
        pyopencv_to_safe(pyobj_a, a, ArgInfo("a", 0)) &&
...
static PyObject* pyopencv_cv_drawMatches(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOOOOOO|OOOO:drawMatches", (char**)keywords, &pyobj_img1, &pyobj_keypoints1, &pyobj_img2, &pyobj_keypoints2, &pyobj_matches1to2, &pyobj_outImg, &pyobj_matchesThickness, &pyobj_matchColor, &pyobj_singlePointColor, &pyobj_matchesMask, &pyobj_flags) &&
        pyopencv_to_safe(pyobj_img1, img1, ArgInfo("img1", 0)) &&
        pyopencv_to_safe(pyobj_keypoints1, keypoints1, ArgInfo("keypoints1", 0)) &&
        pyopencv_to_safe(pyobj_img2, img2, ArgInfo("img2", 0)) &&
        pyopencv_to_safe(pyobj_keypoints2, keypoints2, ArgInfo("keypoints2", 0)) &&
...
static PyObject* pyopencv_cv_estimateAffine2D(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OO|OOOOOO:estimateAffine2D", (char**)keywords, &pyobj_from_, &pyobj_to, &pyobj_inliers, &pyobj_method, &pyobj_ransacReprojThreshold, &pyobj_maxIters, &pyobj_confidence, &pyobj_refineIters) &&
        pyopencv_to_safe(pyobj_from_, from_, ArgInfo("from_", 0)) &&
    ...
    {
        ERRWRAP2(retval = cv::estimateAffine2D(from_, to, inliers, method, ransacReprojThreshold, maxIters, confidence, refineIters));
...
static PyObject* pyopencv_cv_estimateAffinePartial2D(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    const char* keywords[] = { "from_", "to", "inliers", "method", "ransacReprojThreshold", "maxIters", "confidence", "refineIters", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "OO|OOOOOO:estimateAffinePartial2D", (char**)keywords, &pyobj_from_, &pyobj_to, &pyobj_inliers, &pyobj_method, &pyobj_ransacReprojThreshold, &pyobj_maxIters, &pyobj_confidence, &pyobj_refineIters) &&
        pyopencv_to_safe(pyobj_from_, from_, ArgInfo("from_", 0)) &&
        pyopencv_to_safe(pyobj_to, to, ArgInfo("to", 0)) &&
        pyopencv_to_safe(pyobj_inliers, inliers, ArgInfo("inliers", 1)) &&
        pyopencv_to_safe(pyobj_method, method, ArgInfo("method", 0)) &&
        ...
        pyopencv_to_safe(pyobj_refineIters, refineIters, ArgInfo("refineIters", 0)) )
    {
        ERRWRAP2(retval = cv::estimateAffinePartial2D(from_, to, inliers, method, ransacReprojThreshold, maxIters, confidence, refineIters));
        return Py_BuildValue("(NN)", pyopencv_from(retval), pyopencv_from(inliers));
    }
...
static PyObject* pyopencv_cv_estimateRigidTransform(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOO:estimateRigidTransform", (char**)keywords, &pyobj_src, &pyobj_dst, &pyobj_fullAffine) &&
        pyopencv_to_safe(pyobj_src, src, ArgInfo("src", 0)) &&
        pyopencv_to_safe(pyobj_dst, dst, ArgInfo("dst", 0)) &&
        pyopencv_to_safe(pyobj_fullAffine, fullAffine, ArgInfo("fullAffine", 0)) )
    {
    ...
    PyObject* pyobj_fullAffine = NULL;
    bool fullAffine=0;
    PyObject* pyobj_ransacMaxIters = NULL;
    int ransacMaxIters=0;
    PyObject* pyobj_ransacGoodRatio = NULL;
    double ransacGoodRatio=0;
    PyObject* pyobj_ransacSize0 = NULL;
    int ransacSize0=0;
    Mat retval;

    const char* keywords[] = { "src", "dst", "fullAffine", "ransacMaxIters", "ransacGoodRatio", "ransacSize0", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOOOOO:estimateRigidTransform", (char**)keywords, &pyobj_src, &pyobj_dst, &pyobj_fullAffine, &pyobj_ransacMaxIters, &pyobj_ransacGoodRatio, &pyobj_ransacSize0) &&
        pyopencv_to_safe(pyobj_src, src, ArgInfo("src", 0)) &&
        pyopencv_to_safe(pyobj_dst, dst, ArgInfo("dst", 0)) &&
        pyopencv_to_safe(pyobj_fullAffine, fullAffine, ArgInfo("fullAffine", 0)) &&
        pyopencv_to_safe(pyobj_ransacMaxIters, ransacMaxIters, ArgInfo("ransacMaxIters", 0)) &&
        pyopencv_to_safe(pyobj_ransacGoodRatio, ransacGoodRatio, ArgInfo("ransacGoodRatio", 0)) &&
        pyopencv_to_safe(pyobj_ransacSize0, ransacSize0, ArgInfo("ransacSize0", 0)) )
    {
    ...
    pyRaiseCVOverloadException("estimateRigidTransform");
...
static PyObject* pyopencv_cv_findCirclesGrid2(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    const char* keywords[] = { "image", "patternSize", "flags", "blobDetector", "parameters", "centers", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOOOO|O:findCirclesGrid2", (char**)keywords, &pyobj_image, &pyobj_patternSize, &pyobj_flags, &pyobj_blobDetector, &pyobj_parameters, &pyobj_centers) &&
        pyopencv_to_safe(pyobj_image, image, ArgInfo("image", 0)) &&
        pyopencv_to_safe(pyobj_patternSize, patternSize, ArgInfo("patternSize", 0)) &&
        pyopencv_to_safe(pyobj_centers, centers, ArgInfo("centers", 1)) &&
        pyopencv_to_safe(pyobj_flags, flags, ArgInfo("flags", 0)) &&
    ...
    pyRaiseCVOverloadException("findCirclesGrid2");
...
static PyObject* pyopencv_cv_findEssentialMat(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOOOOOO|O:findEssentialMat", (char**)keywords, &pyobj_points1, &pyobj_points2, &pyobj_cameraMatrix, &pyobj_method, &pyobj_prob, &pyobj_threshold, &pyobj_maxIters, &pyobj_mask) &&
        pyopencv_to_safe(pyobj_points1, points1, ArgInfo("points1", 0)) &&
        pyopencv_to_safe(pyobj_points2, points2, ArgInfo("points2", 0)) &&
        pyopencv_to_safe(pyobj_cameraMatrix, cameraMatrix, ArgInfo("cameraMatrix", 0)) &&
        pyopencv_to_safe(pyobj_method, method, ArgInfo("method", 0)) &&
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOOOOOOO|O:findEssentialMat", (char**)keywords, &pyobj_points1, &pyobj_points2, &pyobj_focal, &pyobj_pp, &pyobj_method, &pyobj_prob, &pyobj_threshold, &pyobj_maxIters, &pyobj_mask) &&
        pyopencv_to_safe(pyobj_points1, points1, ArgInfo("points1", 0)) &&
        pyopencv_to_safe(pyobj_points2, points2, ArgInfo("points2", 0)) &&
...
static PyObject* pyopencv_cv_getLogLevel(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv;
...
static PyObject* pyopencv_cv_imwritemulti(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv;
    ...
    const char* keywords[] = { "filename", "img", "params", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "OO|O:imwritemulti", (char**)keywords, &pyobj_filename, &pyobj_img, &pyobj_params) &&
        pyopencv_to_safe(pyobj_filename, filename, ArgInfo("filename", 0)) &&
        pyopencv_to_safe(pyobj_img, img, ArgInfo("img", 0)) &&
        pyopencv_to_safe(pyobj_params, params, ArgInfo("params", 0)) )
    {
...
static PyObject* pyopencv_cv_initWideAngleProjMap(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    PyObject* pyobj_imageSize = NULL;
    Size imageSize;
    PyObject* pyobj_destImageWidth = NULL;
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOOOO|OOOO:initWideAngleProjMap", (char**)keywords, &pyobj_cameraMatrix, &pyobj_distCoeffs, &pyobj_imageSize, &pyobj_destImageWidth, &pyobj_m1type, &pyobj_map1, &pyobj_map2, &pyobj_projType, &pyobj_alpha) &&
        pyopencv_to_safe(pyobj_cameraMatrix, cameraMatrix, ArgInfo("cameraMatrix", 0)) &&
        pyopencv_to_safe(pyobj_distCoeffs, distCoeffs, ArgInfo("distCoeffs", 0)) &&
        pyopencv_to_safe(pyobj_imageSize, imageSize, ArgInfo("imageSize", 0)) &&
        pyopencv_to_safe(pyobj_destImageWidth, destImageWidth, ArgInfo("destImageWidth", 0)) &&
        pyopencv_to_safe(pyobj_m1type, m1type, ArgInfo("m1type", 0)) &&
        pyopencv_to_safe(pyobj_map1, map1, ArgInfo("map1", 1)) &&
        pyopencv_to_safe(pyobj_map2, map2, ArgInfo("map2", 1)) &&
        pyopencv_to_safe(pyobj_projType, projType, ArgInfo("projType", 0)) &&
        pyopencv_to_safe(pyobj_alpha, alpha, ArgInfo("alpha", 0)) )
    {
    ...
    pyRaiseCVOverloadException("initWideAngleProjMap");
...
static PyObject* pyopencv_cv_intersectConvexConvex(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OO|OO:intersectConvexConvex", (char**)keywords, &pyobj_p1, &pyobj_p2, &pyobj_p12, &pyobj_handleNested) &&
        pyopencv_to_safe(pyobj_p1, p1, ArgInfo("p1", 0)) &&
        pyopencv_to_safe(pyobj_p2, p2, ArgInfo("p2", 0)) &&
...
static PyObject* pyopencv_cv_setLogLevel(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv;
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "O:setLogLevel", (char**)keywords, &pyobj_level) &&
...
static PyObject* pyopencv_cv_solveLP(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOO:solveLP", (char**)keywords, &pyobj_Func, &pyobj_Constr, &pyobj_z) &&
        ...
        pyopencv_to_safe(pyobj_z, z, ArgInfo("z", 0)) )
    {
...
static PyObject* pyopencv_cv_dnn_NMSBoxes(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOOO|OO:NMSBoxes", (char**)keywords, &pyobj_bboxes, &pyobj_scores, &pyobj_score_threshold, &pyobj_nms_threshold, &pyobj_eta, &pyobj_top_k) &&
        pyopencv_to_safe(pyobj_bboxes, bboxes, ArgInfo("bboxes", 0)) &&
        pyopencv_to_safe(pyobj_scores, scores, ArgInfo("scores", 0)) &&
...
static PyObject* pyopencv_cv_dnn_Net_readFromModelOptimizer(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OO:Net_readFromModelOptimizer", (char**)keywords, &pyobj_xml, &pyobj_bin) &&
        pyopencv_to_safe(pyobj_xml, xml, ArgInfo("xml", 0)) &&
        pyopencv_to_safe(pyobj_bin, bin, ArgInfo("bin", 0)) )
    {
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OO:Net_readFromModelOptimizer", (char**)keywords, &pyobj_bufferModelConfig, &pyobj_bufferWeights) &&
        pyopencv_to_safe(pyobj_bufferModelConfig, bufferModelConfig, ArgInfo("bufferModelConfig", 0)) &&
        pyopencv_to_safe(pyobj_bufferWeights, bufferWeights, ArgInfo("bufferWeights", 0)) )
    {
...
static PyObject* pyopencv_cv_dnn_blobFromImage(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "O|OOOOOO:blobFromImage", (char**)keywords, &pyobj_image, &pyobj_scalefactor, &pyobj_size, &pyobj_mean, &pyobj_swapRB, &pyobj_crop, &pyobj_ddepth) &&
        ...
        pyopencv_to_safe(pyobj_size, size, ArgInfo("size", 0)) &&
        pyopencv_to_safe(pyobj_mean, mean, ArgInfo("mean", 0)) &&
        pyopencv_to_safe(pyobj_swapRB, swapRB, ArgInfo("swapRB", 0)) &&
        pyopencv_to_safe(pyobj_crop, crop, ArgInfo("crop", 0)) &&
        pyopencv_to_safe(pyobj_ddepth, ddepth, ArgInfo("ddepth", 0)) )
    {
...
static PyObject* pyopencv_cv_dnn_getAvailableTargets(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "O:getAvailableTargets", (char**)keywords, &pyobj_be) &&
        pyopencv_to_safe(pyobj_be, be, ArgInfo("be", 0)) )
    {
...
static PyObject* pyopencv_cv_dnn_imagesFromBlob(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "O|O:imagesFromBlob", (char**)keywords, &pyobj_blob_, &pyobj_images_) &&
        pyopencv_to_safe(pyobj_blob_, blob_, ArgInfo("blob_", 0)) &&
        pyopencv_to_safe(pyobj_images_, images_, ArgInfo("images_", 1)) )
    {
...
static PyObject* pyopencv_cv_dnn_readNetFromCaffe(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "O|O:readNetFromCaffe", (char**)keywords, &pyobj_prototxt, &pyobj_caffeModel) &&
        pyopencv_to_safe(pyobj_prototxt, prototxt, ArgInfo("prototxt", 0)) &&
        pyopencv_to_safe(pyobj_caffeModel, caffeModel, ArgInfo("caffeModel", 0)) )
    {
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "O|O:readNetFromCaffe", (char**)keywords, &pyobj_bufferProto, &pyobj_bufferModel) &&
        pyopencv_to_safe(pyobj_bufferProto, bufferProto, ArgInfo("bufferProto", 0)) &&
        pyopencv_to_safe(pyobj_bufferModel, bufferModel, ArgInfo("bufferModel", 0)) )
    {
...
static PyObject* pyopencv_cv_dnn_readNetFromDarknet(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "O|O:readNetFromDarknet", (char**)keywords, &pyobj_cfgFile, &pyobj_darknetModel) &&
        pyopencv_to_safe(pyobj_cfgFile, cfgFile, ArgInfo("cfgFile", 0)) &&
        pyopencv_to_safe(pyobj_darknetModel, darknetModel, ArgInfo("darknetModel", 0)) )
    {
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "O|O:readNetFromDarknet", (char**)keywords, &pyobj_bufferCfg, &pyobj_bufferModel) &&
        pyopencv_to_safe(pyobj_bufferCfg, bufferCfg, ArgInfo("bufferCfg", 0)) &&
        pyopencv_to_safe(pyobj_bufferModel, bufferModel, ArgInfo("bufferModel", 0)) )
    {
...
static PyObject* pyopencv_cv_dnn_readNetFromONNX(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "O:readNetFromONNX", (char**)keywords, &pyobj_onnxFile) &&
        pyopencv_to_safe(pyobj_onnxFile, onnxFile, ArgInfo("onnxFile", 0)) )
    {
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "O:readNetFromONNX", (char**)keywords, &pyobj_buffer) &&
        pyopencv_to_safe(pyobj_buffer, buffer, ArgInfo("buffer", 0)) )
    {
...
static PyObject* pyopencv_cv_dnn_readNetFromTorch(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "O|OO:readNetFromTorch", (char**)keywords, &pyobj_model, &pyobj_isBinary, &pyobj_evaluate) &&
        pyopencv_to_safe(pyobj_model, model, ArgInfo("model", 0)) &&
        pyopencv_to_safe(pyobj_isBinary, isBinary, ArgInfo("isBinary", 0)) &&
        pyopencv_to_safe(pyobj_evaluate, evaluate, ArgInfo("evaluate", 0)) )
    {
...
static PyObject* pyopencv_cv_dnn_shrinkCaffeModel(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OO|O:shrinkCaffeModel", (char**)keywords, &pyobj_src, &pyobj_dst, &pyobj_layersTypes) &&
        pyopencv_to_safe(pyobj_src, src, ArgInfo("src", 0)) &&
        pyopencv_to_safe(pyobj_dst, dst, ArgInfo("dst", 0)) &&
        pyopencv_to_safe(pyobj_layersTypes, layersTypes, ArgInfo("layersTypes", 0)) )
    {
...
static PyObject* pyopencv_cv_ipp_setUseIPP_NE(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    const char* keywords[] = { "flag", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "O:setUseIPP_NE", (char**)keywords, &pyobj_flag) &&
        pyopencv_to_safe(pyobj_flag, flag, ArgInfo("flag", 0)) )
    {
...
static PyObject* pyopencv_cv_utils_dumpRange(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::utils;
    ...
    const char* keywords[] = { "argument", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "O:dumpRange", (char**)keywords, &pyobj_argument) &&
        pyopencv_to_safe(pyobj_argument, argument, ArgInfo("argument", 0)) )
    {
...
static PyObject* pyopencv_cv_utils_dumpRect(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::utils;
    ...
    const char* keywords[] = { "argument", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "O:dumpRect", (char**)keywords, &pyobj_argument) &&
        pyopencv_to_safe(pyobj_argument, argument, ArgInfo("argument", 0)) )
    {
...
static PyObject* pyopencv_cv_utils_dumpRotatedRect(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::utils;
    ...
    const char* keywords[] = { "argument", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "O:dumpRotatedRect", (char**)keywords, &pyobj_argument) &&
        pyopencv_to_safe(pyobj_argument, argument, ArgInfo("argument", 0)) )
    {
...
static PyObject* pyopencv_cv_utils_dumpString(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::utils;
    ...
    const char* keywords[] = { "argument", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "O:dumpString", (char**)keywords, &pyobj_argument) &&
        pyopencv_to_safe(pyobj_argument, argument, ArgInfo("argument", 0)) )
    {
...
static PyObject* pyopencv_cv_utils_dumpTermCriteria(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::utils;
    ...
    const char* keywords[] = { "argument", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "O:dumpTermCriteria", (char**)keywords, &pyobj_argument) &&
        pyopencv_to_safe(pyobj_argument, argument, ArgInfo("argument", 0)) )
    {
...
static PyObject* pyopencv_cv_utils_dumpVectorOfDouble(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::utils;
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "O:dumpVectorOfDouble", (char**)keywords, &pyobj_vec) &&
        pyopencv_to_safe(pyobj_vec, vec, ArgInfo("vec", 0)) )
    {
...
static PyObject* pyopencv_cv_utils_dumpVectorOfInt(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::utils;
    ...
    const char* keywords[] = { "vec", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "O:dumpVectorOfInt", (char**)keywords, &pyobj_vec) &&
        pyopencv_to_safe(pyobj_vec, vec, ArgInfo("vec", 0)) )
    {
...
static PyObject* pyopencv_cv_utils_dumpVectorOfRect(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::utils;
    ...
    const char* keywords[] = { "vec", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "O:dumpVectorOfRect", (char**)keywords, &pyobj_vec) &&
        pyopencv_to_safe(pyobj_vec, vec, ArgInfo("vec", 0)) )
    {
...
static PyObject* pyopencv_cv_utils_generateVectorOfInt(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::utils;
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "O:generateVectorOfInt", (char**)keywords, &pyobj_len) &&
        pyopencv_to_safe(pyobj_len, len, ArgInfo("len", 0)) )
    {
...
static PyObject* pyopencv_cv_utils_generateVectorOfMat(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::utils;
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOOO|O:generateVectorOfMat", (char**)keywords, &pyobj_len, &pyobj_rows, &pyobj_cols, &pyobj_dtype, &pyobj_vec) &&
        pyopencv_to_safe(pyobj_len, len, ArgInfo("len", 0)) &&
...
static PyObject* pyopencv_cv_utils_generateVectorOfRect(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::utils;
    ...
    const char* keywords[] = { "len", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "O:generateVectorOfRect", (char**)keywords, &pyobj_len) &&
        pyopencv_to_safe(pyobj_len, len, ArgInfo("len", 0)) )
    {
...
static PyObject* pyopencv_cv_utils_testOverloadResolution(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::utils;
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "O|O:testOverloadResolution", (char**)keywords, &pyobj_value, &pyobj_point) &&
        pyopencv_to_safe(pyobj_value, value, ArgInfo("value", 0)) &&
        pyopencv_to_safe(pyobj_point, point, ArgInfo("point", 0)) )
    {
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "O:testOverloadResolution", (char**)keywords, &pyobj_rect) &&
        pyopencv_to_safe(pyobj_rect, rect, ArgInfo("rect", 0)) )
    {
...
static PyObject* pyopencv_cv_utils_testRaiseGeneralException(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::utils;
...
static PyObject* pyopencv_cv_utils_testReservedKeywordConversion(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::utils;
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "O|OO:testReservedKeywordConversion", (char**)keywords, &pyobj_positional_argument, &pyobj_lambda_, &pyobj_from_) &&
        pyopencv_to_safe(pyobj_positional_argument, positional_argument, ArgInfo("positional_argument", 0)) &&
        pyopencv_to_safe(pyobj_lambda_, lambda_, ArgInfo("lambda_", 0)) &&
        pyopencv_to_safe(pyobj_from_, from_, ArgInfo("from_", 0)) )
    {
        ERRWRAP2(retval = cv::utils::testReservedKeywordConversion(positional_argument, lambda_, from_));
        return pyopencv_from(retval);
    }
